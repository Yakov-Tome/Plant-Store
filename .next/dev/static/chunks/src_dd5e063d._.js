...
"[project]/src/app/catalog/CatalogClient.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CatalogClient() {
    ...
    if ($[0] !== "53763dc404baabe5922c5be733ea9abdf348c95e2ced3ed419a32ff41ab6aa04") {
        for(let $i = 0; $i < 60; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "53763dc404baabe5922c5be733ea9abdf348c95e2ced3ed419a32ff41ab6aa04";
    }
    ...
    bb0: {
        ...
        if ($[8] !== categoryId || $[9] !== products || $[10] !== searchQuery || $[11] !== subcategoryId) {
            ...
            if (subcategoryId) {
                list = list.filter({
                    "CatalogClient[list.filter()]": (prod)=>{
                ...
                }["CatalogClient[list.filter()]"]);
            } else {
                if (categoryId) {
                    list = list.filter({
                        "CatalogClient[list.filter()]": (prod_0)=>{
            ...
            if (searchQuery) {
                list = list.filter({
                    "CatalogClient[list.filter()]": (prod_1)=>{
    ...
    if ($[13] !== categories || $[14] !== categoryId) {
        t4 = ({
            "CatalogClient[getCategoryName]": ()=>{
                if (!categoryId) {
                    return "\u05DB\u05DC \u05D4\u05DE\u05D5\u05E6\u05E8\u05D9\u05DD";
                }
                const cat = (categories || []).find({
                    "CatalogClient[getCategoryName > (anonymous)()]": (c)=>c.id === categoryId
                }["CatalogClient[getCategoryName > (anonymous)()]"]);
    ...
    if ($[16] !== subcategories || $[17] !== subcategoryId) {
        t5 = ({
            "CatalogClient[getSubcategoryName]": ()=>{
                if (!subcategoryId) {
                    return null;
                }
                const sub = (subcategories || []).find({
                    "CatalogClient[getSubcategoryName > (anonymous)()]": (s)=>s.id === subcategoryId
                }["CatalogClient[getSubcategoryName > (anonymous)()]"]);
    ...
    if ($[21] !== categories || $[22] !== showFilters || $[23] !== subcategories) {
        t8 = showFilters ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$CatalogFiltersBar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                onCloseFilters: {
                    "CatalogClient[<CatalogFiltersBar>.onCloseFilters]": ()=>setShowFilters(false)
                }["CatalogClient[<CatalogFiltersBar>.onCloseFilters]"],
            ...
            onClick: {
                "CatalogClient[<button>.onClick]": ()=>setShowFilters(true)
            }["CatalogClient[<button>.onClick]"],
            children: [
                "הצג מסננים",
    ...
    if ($[45] !== addToCart || $[46] !== cart || $[47] !== decreaseQuantity || $[48] !== error || $[49] !== filteredProducts || $[50] !== loading || $[51] !== setItemQuantity) {
        t17 = !loading && !error && filteredProducts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: filteredProducts.map({
                "CatalogClient[filteredProducts.map()]": (prod_2)=>{
                    const productSlug = prod_2.slug || prod_2.id;
                    const cartItem = cart.find({
                        "CatalogClient[filteredProducts.map() > cart.find()]": (item)=>item.id === prod_2.id
                    }["CatalogClient[filteredProducts.map() > cart.find()]"]);
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                            ...
                            children: [
                                ...
                                quantity === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: {
                                        "CatalogClient[filteredProducts.map() > <button>.onClick]": (e)=>{
                                            e.preventDefault();
                                            e.stopPropagation();
                                            addToCart(prod_2);
                                        }
                                    }["CatalogClient[filteredProducts.map() > <button>.onClick]"],
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            type: "button",
                                            onClick: {
                                                "CatalogClient[filteredProducts.map() > <button>.onClick]": (e_0)=>{
                                                    e_0.preventDefault();
                                                    e_0.stopPropagation();
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            min: 0,
                                            value: quantity,
                                            onClick: _CatalogClientFilteredProductsMapInputOnClick,
                                            onChange: {
                                                "CatalogClient[filteredProducts.map() > <input>.onChange]": (e_2)=>{
                                                    e_2.preventDefault();
                                                    e_2.stopPropagation();
                                                    const value = Number(e_2.target.value);
                                                    setItemQuantity(prod_2, value);
                                                }
                                            }["CatalogClient[filteredProducts.map() > <input>.onChange]"],
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            type: "button",
                                            onClick: {
                                                "CatalogClient[filteredProducts.map() > <button>.onClick]": (e_3)=>{
                                                    e_3.preventDefault();
                                                    e_3.stopPropagation();
                                                    addToCart(prod_2);
                                                }
            ...
            }["CatalogClient[filteredProducts.map()]"])
        }, void 0, false, {
            fileName: "[project]/src/app/catalog/CatalogClient.js",
            lineNumber: 255,
            columnNumber: 64
...
_s(CatalogClient, "Ov4LfPopugLWGJRFflH9LybqYJM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
...
_c = CatalogClient;
function _CatalogClientFilteredProductsMapInputOnClick(e_1) {
    e_1.preventDefault();
    e_1.stopPropagation();
}
var _c;
...
//# sourceMappingURL=src_dd5e063d._.js.map